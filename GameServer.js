...
function GameServer() {
    ...
    this.config = {
        ...
        minionStartSize: 50,        // Start size of minions (mass = 32*32/100 = 10.24)
        minionMaxStartSize: 70,     // Maximum value of random start size for minions (set value higher than minionStartSize to enable)
